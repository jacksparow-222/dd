        ...
        <div className="max-w-5xl mx-auto">
          <div className="bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 rounded-3xl overflow-hidden shadow-2xl">
            <div className="grid md:grid-cols-2">
              ...
              <div className="p-12 text-white">
                <div className="inline-flex items-center gap-2 px-4 py-2 bg-amber-500/20 border border-amber-500/30 rounded-full text-amber-400 text-sm font-semibold mb-6" role="status" aria-label="Offre Premium">
                ...
                <div className="space-y-4 mb-10">
                  {[
                    ...
                    <div key={i} className="flex items-center gap-3" key={`benefit-${i}`}>
                      <div className="w-6 h-6 rounded-full bg-amber-500/20 border border-amber-500/30 flex items-center justify-center flex-shrink-0" aria-hidden="true">
                ...
                <a 
                  ...
                  className="group inline-flex items-center justify-center gap-3 px-8 py-5 bg-gradient-to-r from-amber-500 to-amber-600 text-white font-bold rounded-xl shadow-2xl hover:shadow-amber-500/50 transform hover:-translate-y-1 transition-all duration-300 w-full md:w-auto focus:outline-none focus:ring-4 focus:ring-amber-500/50"
                  ...
                  <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20 hover:bg-white/20 transition-all duration-300">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <a href={`mailto:${email}`} className="text-white font-semibold hover:text-amber-100 transition-colors break-all focus:outline-none focus:ring-2 focus:ring-white/50 rounded" aria-label={`Envoyer un email à ${email}`}>
                          {email}
                        </a>
                      </div>
                    </div>
                  ...
                  <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20 hover:bg-white/20 transition-all duration-300">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <a href={`tel:+${whatsapp}`} className="text-white font-semibold hover:text-amber-100 transition-colors focus:outline-none focus:ring-2 focus:ring-white/50 rounded" aria-label={`Appeler le numéro WhatsApp ${whatsapp}`}>
                          +{whatsapp}
                        </a>
                      </div>
                    </div>
          ...
          <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              <div key={i} className="text-center p-6 bg-white rounded-2xl shadow-lg border border-slate-100 hover:shadow-xl transition-shadow duration-300" key={`trust-${i}`}>
